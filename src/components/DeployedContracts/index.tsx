  ...
  return (
    <div className="mt-3 pb-2 border-bottom border-secondary">
      <div className="d-flex justify-content-between align-items-center">
        <span className="text-light">Deployed contracts</span>

        <svg onClick={removeAllContracts} xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-trash text-light" viewBox="0 0 16 16">
